 ...
 */
class CustomerTokenAuthenticator extends AbstractGuardAuthenticator
{
    /**
     * @var EntityManager
     */
    ...
    {
        if (!$user->getRoleCollection()->contains($this->em->getRepository('AppBundle:Role')->findOneBy(['role' => Role::ROLE_CUSTOMER])))
