...
use ProviderBundle\Form\ProviderType;
...
class RegistrationController extends FOSRestController
{
    ...
    public function registerAction(Request $request)
    {
        ...
        // build the form
        $user = new User();
        $form = $this->createForm(ProviderType::class, $user, array('csrf_protection' => false));
        ...
        if ($form->isValid()) {
            ...
            $user->addRole($em->getRepository('AppBundle:Role')->findOneBy(['role' => Role::ROLE_PROVIDER]));
